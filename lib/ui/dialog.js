				...
				template: '\
					<div class="ui-dialog  <%=customClassName%>">\
						...
						<%if(confirm || cancel){%>\
							<div class="buttons">\
							<%if(confirm && !cancel){%>\
								<div class="dialog-ok only clearfix"><div class="btnleft"></div><div class="btncenter"><%=confirm%></div><div class="btnright"></div></div>\
							<%}else{%>\
								<%if(cancel){%>\
									<div class="dialog-cancel clearfix"><div class="btnleft"></div><div class="btncenter"><%=cancel%></div><div class="btnright"></div></div>\
								<%}%>\
								<%if(confirm){%>\
									<div class="dialog-ok clearfix"><div class="btnleft"></div><div class="btncenter"><%=confirm%></div><div class="btnright"></div></div>\
								<%}%>\
							<%}%>\
							</div>\
						<%}%>\
